...
def test_resume_from_enriched_cache(
    ...
    # Resume from cache with the same custom input to reuse custom_tool_set
    # Note: With the new behavior, providing the custom input is necessary to keep using custom_tool_set
    execute_run(
        from_date="7d",
        to_date=None,
        bio_thresholds=(0.6, 0.6),
